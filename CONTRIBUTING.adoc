# Contributing to karaf-features-subethamail

## Installing the correct versions of Java, Maven and necessary dependencies

karaf-features-subethamail is currently built on top of JDK 11.
...
You can file new issues by filling out our https://github.com/BlackBeltTechnology/karaf-features-subethamail/issues/new/choose[issue form].
